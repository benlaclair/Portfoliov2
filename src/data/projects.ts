...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    outcome: 'A static-first Astro site with one React island, GSAP for purposeful motion, dark/light chapter rhythm, and case studies that lead with the problem, decision, and outcome — not a hero shot.',
