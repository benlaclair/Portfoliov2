...
export const vlierProblems = [
  ...
  },
  {
    ...
    body: 'Getting from a product page to a CAD download meant reading a dense table, finding a tiny icon, and hoping you clicked the right one. There was no scent trail.',
  },
];
