import type { CaseStudy, StatItem, DecisionItem } from './types';
...
const decisions: DecisionItem[] = [
  {
    ...
    after: 'Phase 3: Clash Display + Satoshi + JetBrains Mono. The accent role moved from an italic serif to a muted indigo <span class="accent">.',
  },
  {
    number: '02',
    ...
    description:
      'The homepage reads as a sequence of chapters — Loader, Hero, Tagline, Vbreak, VerticalWork, Timeline, CTA, Footer. Dark anchors (Hero, Vbreak, CTA, Footer) frame light reading beats so the page has a chromatic pulse instead of a single tone. A body[data-mode] tracker swaps the cursor color as the user scrolls between modes.',
    before: 'Single warm-parchment tone for every section',
    after: 'D · D · L · D · L · L · D · D rhythm, cursor flips per section',
  },
  {
    number: '03',
    label: 'Identity',
    ...
    description:
      'A geometric B inside a rounded square, with an indigo accent circle, replaces the Phase 2 italic-Instrument-Serif "Ben." wordmark. Three variants share the same paths: a framed 44×44 mark in the navbar, an unframed 96×96 mark in the footer, and a stroke-painted version in the loader that animates via stroke-dashoffset. currentColor lets the same SVG read on light or dark sections.',
